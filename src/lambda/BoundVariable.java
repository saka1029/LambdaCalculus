...
public class BoundVariable implements Variable {
     ...
     * コンストラクタです。
     *
     * @param lambda この束縛変数を定義しているラムダ式を指定します。
     */
    ...
    /**
     * 簡約します。
     * contextの束縛変数環境に自分自身があれば 関連付けられた値を返します。
     * なければ自分自身を返します。
     */
    @Override
    ...
    /**
     * 正規化します。
     * contextの束縛変数環境にlambdaがあれば
     * (自分自身を定義するラムダ式があれば) 関連付けられた値を返します。
     * なければ自分自身を返します。
     */
    @Override
    ...
    /**
     * 引数の名前が同じであるかどうかを返します。
     * つまり自分自身を定義するラムダ式のnameが同じであるかどうかを返します。
     * 自分自身を定義するラムダ式が異なっていてもnameが同じであればtrueを返します。
     */
    @Override
