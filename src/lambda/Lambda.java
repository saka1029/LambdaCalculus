...
public class Lambda implements Term, Applicable {
     ...
     * @throws IllegalArgumentException 引数nameがnullです。
     */
    Lambda(String name) {
     ...
     * @throws IllegalStateException このメソッドが二回以上呼び出されています。
     */
     ...
     * 例えば {@code λx.λy.x} の場合、 {@code λ$0.λ$1.$0} を返します。
     */
    @Override
    ...
    /**
     * 文字列表現を返します。
     * 例えばラムダ式 {@code λx.λy.x} に対して
     * {@code LambdaCalculus.TO_STRING_DOT} がtrueの時は
     * {@code "x.y.x"}を、
     * falseの時は
     * {@code "λx y.x"}を返します。
     */
