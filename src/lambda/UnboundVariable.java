...
public class UnboundVariable implements Variable {
     ...
     * コンストラクタです。
     * 
     * @param name 変数の名前を指定します。
     * @throws IllegalArgumentException {@code name}がnullの時にスローします。
     */
    ...
    /**
     * 簡約します。
     * {@code context#unbound}にこの変数があれば、それに対応する値を返します。
     * ない場合は自分自身を返します。
     */
    @Override
...
//        return context.unbound.getOrDefault(this, this);
     ...
     * {@link UnboundVariable}は束縛変数ではないので、
     * この実装では常にfalseを返します。
     */
    @Override
